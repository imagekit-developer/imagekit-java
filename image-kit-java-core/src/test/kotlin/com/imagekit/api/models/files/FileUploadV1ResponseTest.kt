...
internal class FileUploadV1ResponseTest {

    @Test
    fun create() {
        val fileUploadV1Response =
            FileUploadV1Response.builder()
                .addAiTag(
                    FileUploadV1Response.AiTag.builder()
                        .confidence(0.0)
                        .name("name")
                        .source("source")
                        .build()
                ...
                .duration(0L)
                .embeddedMetadata(
                    FileUploadV1Response.EmbeddedMetadata.builder()
                ...
                .extensionStatus(
                    FileUploadV1Response.ExtensionStatus.builder()
                        .awsAutoTagging(FileUploadV1Response.ExtensionStatus.AwsAutoTagging.SUCCESS)
                        .googleAutoTagging(
                            FileUploadV1Response.ExtensionStatus.GoogleAutoTagging.SUCCESS
                        )
                        .removeBg(FileUploadV1Response.ExtensionStatus.RemoveBg.SUCCESS)
                        .build()
                )
                .fileId("fileId")
                .filePath("filePath")
                ...
                .isPublished(true)
                .metadata(
                    FileUploadV1Response.Metadata.builder()
                        .audioCodec("audioCodec")
                        .bitRate(0L)
                        .density(0L)
                        .duration(0L)
                        .exif(
                            FileUploadV1Response.Metadata.Exif.builder()
                                .exif(
                                    ExifDetails.builder()
                                        .apertureValue(0.0)
                                        .colorSpace(0L)
                                ...
                                .makernote(
                                    FileUploadV1Response.Metadata.Exif.Makernote.builder()
                ...
                .url("url")
                .versionInfo(
                    FileUploadV1Response.VersionInfo.builder().id("id").name("name").build()
                )
                .videoCodec("videoCodec")
                .width(0.0)
                .build()

        assertThat(fileUploadV1Response.aiTags().getOrNull())
            .containsExactly(
                FileUploadV1Response.AiTag.builder()
                    .confidence(0.0)
                    .name("name")
        ...
        assertThat(fileUploadV1Response.audioCodec()).contains("audioCodec")
        assertThat(fileUploadV1Response.bitRate()).contains(0L)
        assertThat(fileUploadV1Response.customCoordinates()).contains("customCoordinates")
        assertThat(fileUploadV1Response._customMetadata())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(fileUploadV1Response.duration()).contains(0L)
        assertThat(fileUploadV1Response.embeddedMetadata())
            .contains(
                FileUploadV1Response.EmbeddedMetadata.builder()
                    .aboutCvTermCvId("http://example.com/cv/about/ref2019.1")
                    .aboutCvTermId("http://example.com/cv/about/ref2019.1/code987")
        ...
        assertThat(fileUploadV1Response.extensionStatus())
            .contains(
                FileUploadV1Response.ExtensionStatus.builder()
                    .awsAutoTagging(FileUploadV1Response.ExtensionStatus.AwsAutoTagging.SUCCESS)
                    .googleAutoTagging(
        ...
        assertThat(fileUploadV1Response.fileId()).contains("fileId")
        assertThat(fileUploadV1Response.filePath()).contains("filePath")
        assertThat(fileUploadV1Response.fileType()).contains("fileType")
        assertThat(fileUploadV1Response.height()).contains(0.0)
        assertThat(fileUploadV1Response.isPrivateFile()).contains(true)
        assertThat(fileUploadV1Response.isPublished()).contains(true)
        assertThat(fileUploadV1Response.metadata())
            .contains(
                FileUploadV1Response.Metadata.builder()
                    .audioCodec("audioCodec")
                    .bitRate(0L)
        ...
        assertThat(fileUploadV1Response.name()).contains("name")
        assertThat(fileUploadV1Response.size()).contains(0.0)
        assertThat(fileUploadV1Response.tags().getOrNull()).containsExactly("string")
        assertThat(fileUploadV1Response.thumbnailUrl()).contains("thumbnailUrl")
        assertThat(fileUploadV1Response.url()).contains("url")
        assertThat(fileUploadV1Response.versionInfo())
            .contains(FileUploadV1Response.VersionInfo.builder().id("id").name("name").build())
        assertThat(fileUploadV1Response.videoCodec()).contains("videoCodec")
        assertThat(fileUploadV1Response.width()).contains(0.0)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedFileUploadV1Response =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fileUploadV1Response),
                jacksonTypeRef<FileUploadV1Response>(),
            )

        assertThat(roundtrippedFileUploadV1Response).isEqualTo(fileUploadV1Response)
    }
}
