    ...
    fun ofS3() {
        val s3 =
            OriginCreateResponse.S3.builder()
                ...
                .name("US S3 Storage")
                .prefix("raw-assets")
                .type(OriginCreateResponse.S3.Type.S3)
    ...
    fun ofS3Compatible() {
        val s3Compatible =
            OriginCreateResponse.S3Compatible.builder()
                ...
                .type(OriginCreateResponse.S3Compatible.Type.S3_COMPATIBLE)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
    ...
    fun ofCloudinaryBackup() {
        val cloudinaryBackup =
            OriginCreateResponse.CloudinaryBackup.builder()
                ...
                .name("US S3 Storage")
                .prefix("raw-assets")
                .type(OriginCreateResponse.CloudinaryBackup.Type.CLOUDINARY_BACKUP)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
    ...
    fun ofWebFolder() {
        val webFolder =
            OriginCreateResponse.WebFolder.builder()
                ...
                .includeCanonicalHeader(false)
                .name("US S3 Storage")
                .type(OriginCreateResponse.WebFolder.Type.WEB_FOLDER)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
    ...
    fun ofWebProxy() {
        val webProxy =
            OriginCreateResponse.WebProxy.builder()
                ...
                .includeCanonicalHeader(false)
                .name("US S3 Storage")
                .type(OriginCreateResponse.WebProxy.Type.WEB_PROXY)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
    ...
    fun ofGoogleCloudStorageGcs() {
        val googleCloudStorageGcs =
            OriginCreateResponse.GoogleCloudStorageGcs.builder()
                ...
                .name("US S3 Storage")
                .prefix("products")
                .type(OriginCreateResponse.GoogleCloudStorageGcs.Type.GCS)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
    ...
    fun ofAzureBlobStorage() {
        val azureBlobStorage =
            OriginCreateResponse.AzureBlobStorage.builder()
                ...
                .name("US S3 Storage")
                .prefix("uploads")
                .type(OriginCreateResponse.AzureBlobStorage.Type.AZURE_BLOB)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
    ...
    fun ofAkeneoPim() {
        val akeneoPim =
            OriginCreateResponse.AkeneoPim.builder()
                ...
                .includeCanonicalHeader(false)
                .name("US S3 Storage")
                .type(OriginCreateResponse.AkeneoPim.Type.AKENEO_PIM)
                .baseUrlForCanonicalHeader("https://cdn.example.com")
                .build()
