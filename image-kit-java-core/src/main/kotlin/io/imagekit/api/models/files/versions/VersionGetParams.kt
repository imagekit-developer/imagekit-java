...
private constructor(
    ...
    /** A builder for [VersionGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(versionGetParams: VersionGetParams) = apply {
            fileId = versionGetParams.fileId
            versionId = versionGetParams.versionId
            additionalHeaders = versionGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = versionGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VersionGetParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VersionGetParams &&
            fileId == other.fileId &&
    ...
    override fun hashCode(): Int =
        Objects.hash(fileId, versionId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "VersionGetParams{fileId=$fileId, versionId=$versionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
