...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): FileGetParams =
            FileGetParams(fileId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "FileGetParams{fileId=$fileId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
