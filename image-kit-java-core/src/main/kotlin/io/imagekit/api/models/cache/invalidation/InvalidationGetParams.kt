...
private constructor(
    ...
    /** A builder for [InvalidationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invalidationGetParams: InvalidationGetParams) = apply {
            requestId = invalidationGetParams.requestId
            additionalHeaders = invalidationGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = invalidationGetParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): InvalidationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvalidationGetParams &&
    ...
    override fun toString() =
        "InvalidationGetParams{requestId=$requestId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
