...
import io.imagekit.api.core.http.HttpClient
import io.imagekit.api.core.http.PhantomReachableClosingHttpClient
import io.imagekit.api.core.http.QueryParams
import io.imagekit.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Defaults to [io.imagekit.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [io.imagekit.api.core.jsonMapper]. The default is usually sufficient and
