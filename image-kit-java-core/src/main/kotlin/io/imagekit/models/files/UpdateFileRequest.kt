...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = updateFileRequest.accept(new UpdateFileRequest.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitDetails(UpdateFileDetails details) {
     *         return Optional.of(details.toString());
     *     }
     *
     *     // ...
     *
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = removeAiTags.accept(new RemoveAiTags.Visitor<Optional<String>>() {
             *     @Override
