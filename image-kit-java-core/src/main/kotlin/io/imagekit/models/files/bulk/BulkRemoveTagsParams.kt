...
private constructor(
    ...
    /** A builder for [BulkRemoveTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkRemoveTagsParams: BulkRemoveTagsParams) = apply {
            body = bulkRemoveTagsParams.body.toBuilder()
            additionalHeaders = bulkRemoveTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = bulkRemoveTagsParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): BulkRemoveTagsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkRemoveTagsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BulkRemoveTagsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
