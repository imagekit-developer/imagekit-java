...
private constructor(
    ...
    /** A builder for [FolderMoveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderMoveResponse: FolderMoveResponse) = apply {
            jobId = folderMoveResponse.jobId
            additionalProperties = folderMoveResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): FolderMoveResponse =
            FolderMoveResponse(checkRequired("jobId", jobId), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FolderMoveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FolderMoveResponse &&
            jobId == other.jobId &&
    ...
    override fun toString() =
        "FolderMoveResponse{jobId=$jobId, additionalProperties=$additionalProperties}"
}
