...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionListParams: VersionListParams) = apply {
            fileId = versionListParams.fileId
        ...
        fun build(): VersionListParams =
            VersionListParams(fileId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "VersionListParams{fileId=$fileId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
