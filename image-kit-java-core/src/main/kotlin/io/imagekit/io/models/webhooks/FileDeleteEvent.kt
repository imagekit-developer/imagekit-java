...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileDeleteEvent].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileDeleteEvent: FileDeleteEvent) = apply {
            id = fileDeleteEvent.id
            type = fileDeleteEvent.type
            createdAt = fileDeleteEvent.createdAt
            data = fileDeleteEvent.data
            additionalProperties = fileDeleteEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileDeleteEvent].
         *
    ...
    fun validate(): FileDeleteEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileDeleteEvent &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "FileDeleteEvent{id=$id, type=$type, createdAt=$createdAt, data=$data, additionalProperties=$additionalProperties}"
}
