...
package io.imagekit.io.models.folders.job
...
private constructor(
    ...
    ) : this(jobId, purgeRequestId, status, type, mutableMapOf())
    ...
    /**
     * Unique identifier of the purge request. This will be present only if `purgeCache` is set to
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(jobGetResponse: JobGetResponse) = apply {
            jobId = jobGetResponse.jobId
            purgeRequestId = jobGetResponse.purgeRequestId
            status = jobGetResponse.status
            type = jobGetResponse.type
            additionalProperties = jobGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Unique identifier of the purge request. This will be present only if `purgeCache` is set
         * to `true` in the rename folder API request.
         */
         ...
         */
        fun build(): JobGetResponse =
            JobGetResponse(jobId, purgeRequestId, status, type, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): JobGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (jobId.asKnown().isPresent) 1 else 0) +
            (if (purgeRequestId.asKnown().isPresent) 1 else 0) +
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw ImageKitInvalidDataException("Unknown Status: $value")
            }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MOVE_FOLDER = of("MOVE_FOLDER")

            @JvmField val RENAME_FOLDER = of("RENAME_FOLDER")
        ...
        fun value(): Value =
            when (this) {
                ...
                MOVE_FOLDER -> Value.MOVE_FOLDER
                RENAME_FOLDER -> Value.RENAME_FOLDER
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ...
                MOVE_FOLDER -> Known.MOVE_FOLDER
                RENAME_FOLDER -> Known.RENAME_FOLDER
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JobGetResponse &&
            jobId == other.jobId &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(jobId, purgeRequestId, status, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "JobGetResponse{jobId=$jobId, purgeRequestId=$purgeRequestId, status=$status, type=$type, additionalProperties=$additionalProperties}"
}
