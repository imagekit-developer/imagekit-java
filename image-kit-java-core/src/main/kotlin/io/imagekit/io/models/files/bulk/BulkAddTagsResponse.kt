...
private constructor(
    ...
    /** A builder for [BulkAddTagsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkAddTagsResponse: BulkAddTagsResponse) = apply {
            successfullyUpdatedFileIds =
                bulkAddTagsResponse.successfullyUpdatedFileIds.map { it.toMutableList() }
            additionalProperties = bulkAddTagsResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): BulkAddTagsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkAddTagsResponse &&
    ...
    override fun toString() =
        "BulkAddTagsResponse{successfullyUpdatedFileIds=$successfullyUpdatedFileIds, additionalProperties=$additionalProperties}"
}
