...
interface UsageAnalyticsServiceAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageAnalyticsServiceAsync
     ...
     */
    fun get(params: UsageAnalyticsGetParams): CompletableFuture<UsageAnalyticsResponse> =
    ...
    /**
     * A view of [UsageAnalyticsServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [UsageAnalyticsServiceAsync.get].
         */
        fun get(
            params: UsageAnalyticsGetParams
