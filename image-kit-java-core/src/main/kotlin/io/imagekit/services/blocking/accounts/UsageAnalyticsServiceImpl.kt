...
class UsageAnalyticsServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    UsageAnalyticsService {

    private val withRawResponse: UsageAnalyticsService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): UsageAnalyticsService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageAnalyticsService =
        UsageAnalyticsServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            UsageAnalyticsServiceImpl.WithRawResponseImpl(
