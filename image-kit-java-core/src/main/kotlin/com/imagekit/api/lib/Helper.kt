...
class Helper(private val privateKey: String) : HelperService {
    ...
    private fun processOverlay(overlay: com.imagekit.api.models.Overlay): String {
        ...
        var position: com.imagekit.api.models.OverlayPosition? = null
        var timing: com.imagekit.api.models.OverlayTiming? = null
    ...
    private fun buildTextOverlayTransformation(
        transformations: List<com.imagekit.api.models.TextOverlayTransformation>
    ): String {
        val entries = mutableListOf<String>()
        for (transform in transformations) {
    ...
    private fun buildSubtitleOverlayTransformation(
        transformations: List<com.imagekit.api.models.SubtitleOverlayTransformation>
    ): String {
        val entries = mutableListOf<String>()
        for (transform in transformations) {
    ...
    private fun buildSolidColorOverlayTransformation(
        transformations: List<com.imagekit.api.models.SolidColorOverlayTransformation>
    ): String {
        val entries = mutableListOf<String>()
        for (transform in transformations) {
    ...
    private fun processTextOverlayTransformation(
        transform: com.imagekit.api.models.TextOverlayTransformation,
    ...
    private fun processSolidColorOverlayTransformation(
        transform: com.imagekit.api.models.SolidColorOverlayTransformation,
        parts: MutableList<String>,
    ) {
        transform.width().ifPresent { w ->
            when {
    ...
    private fun processSubtitleOverlayTransformation(
        transform: com.imagekit.api.models.SubtitleOverlayTransformation,
        parts: MutableList<String>,
    ) {
        transform.background().ifPresent { bg -> parts.add("bg-$bg") }
    ...
    private fun processOverlayPosition(
        position: com.imagekit.api.models.OverlayPosition,
        parts: MutableList<String>,
    ) {
    ...
    private fun processOverlayTiming(
        timing: com.imagekit.api.models.OverlayTiming,
        parts: MutableList<String>,
    ) {
