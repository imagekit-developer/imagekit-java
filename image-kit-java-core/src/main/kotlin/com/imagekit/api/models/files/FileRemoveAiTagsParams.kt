...
/**
 * This API removes AITags from multiple files in bulk. A maximum of 50 files can be specified at a
 * time.
 */
class FileRemoveAiTagsParams
private constructor(
     ...
     */
    fun aiTags(): List<String> = body.aiTags()
     ...
     */
    fun _aiTags(): JsonField<List<String>> = body._aiTags()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileRemoveAiTagsParams].
         *
    ...
    /** A builder for [FileRemoveAiTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileRemoveAiTagsParams: FileRemoveAiTagsParams) = apply {
            body = fileRemoveAiTagsParams.body.toBuilder()
            additionalHeaders = fileRemoveAiTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileRemoveAiTagsParams.additionalQueryParams.toBuilder()
        }
        ...
        /** An array of AITags that you want to remove from the files. */
        fun aiTags(aiTags: List<String>) = apply { body.aiTags(aiTags) }

        /**
         * Sets [Builder.aiTags] to an arbitrary JSON value.
         *
         * You should usually call [Builder.aiTags] with a well-typed `List<String>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun aiTags(aiTags: JsonField<List<String>>) = apply { body.aiTags(aiTags) }

        /**
         * Adds a single [String] to [aiTags].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAiTag(aiTag: String) = apply { body.addAiTag(aiTag) }
        ...
        /**
         * Returns an immutable instance of [FileRemoveAiTagsParams].
         *
         ...
         */
        fun build(): FileRemoveAiTagsParams =
    ...
    private constructor(
        ...
        private constructor(
            @JsonProperty("AITags")
            @ExcludeMissing
            aiTags: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("fileIds")
            @ExcludeMissing
            fileIds: JsonField<List<String>> = JsonMissing.of(),
        ) : this(aiTags, fileIds, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun aiTags(): List<String> = aiTags.getRequired("AITags")
         ...
         * Unlike [aiTags], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("AITags") @ExcludeMissing fun _aiTags(): JsonField<List<String>> = aiTags
        ...
        class Builder internal constructor() {
            ...
            private var aiTags: JsonField<MutableList<String>>? = null
            private var fileIds: JsonField<MutableList<String>>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(body: Body) = apply {
                aiTags = body.aiTags.map { it.toMutableList() }
                fileIds = body.fileIds.map { it.toMutableList() }
                additionalProperties = body.additionalProperties.toMutableMap()
            }

            /** An array of AITags that you want to remove from the files. */
            fun aiTags(aiTags: List<String>) = aiTags(JsonField.of(aiTags))

            /**
             * Sets [Builder.aiTags] to an arbitrary JSON value.
             *
             * You should usually call [Builder.aiTags] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun aiTags(aiTags: JsonField<List<String>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addAiTag(aiTag: String) = apply {
                aiTags =
            ...
            fun build(): Body =
                Body(
                    checkRequired("aiTags", aiTags).map { it.toImmutable() },
        ...
        internal fun validity(): Int =
            (aiTags.asKnown().getOrNull()?.size ?: 0) + (fileIds.asKnown().getOrNull()?.size ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(aiTags, fileIds, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{aiTags=$aiTags, fileIds=$fileIds, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileRemoveAiTagsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FileRemoveAiTagsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
