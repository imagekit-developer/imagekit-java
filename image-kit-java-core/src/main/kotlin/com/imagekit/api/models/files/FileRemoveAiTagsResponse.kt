...
class FileRemoveAiTagsResponse
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FileRemoveAiTagsResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileRemoveAiTagsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileRemoveAiTagsResponse: FileRemoveAiTagsResponse) = apply {
            successfullyUpdatedFileIds =
                fileRemoveAiTagsResponse.successfullyUpdatedFileIds.map { it.toMutableList() }
            additionalProperties = fileRemoveAiTagsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileRemoveAiTagsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileRemoveAiTagsResponse =
    ...
    fun validate(): FileRemoveAiTagsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileRemoveAiTagsResponse &&
    ...
    override fun toString() =
        "FileRemoveAiTagsResponse{successfullyUpdatedFileIds=$successfullyUpdatedFileIds, additionalProperties=$additionalProperties}"
}
