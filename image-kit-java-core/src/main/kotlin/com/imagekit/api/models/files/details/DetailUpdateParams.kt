...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(detailUpdateParams: DetailUpdateParams) = apply {
            fileId = detailUpdateParams.fileId
            body = detailUpdateParams.body
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [customCoordinates], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("customCoordinates")
            @ExcludeMissing
             ...
             *
             * Unlike [extensions], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("extensions")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * are processed.
                 */
                fun removeAiTags(removeAiTags: RemoveAiTags) =
                    removeAiTags(JsonField.of(removeAiTags))

                /**
                 * Sets [Builder.removeAiTags] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.removeAiTags] with a well-typed [RemoveAiTags]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(
                ...
                override fun hashCode(): Int = Objects.hash(removedotBg, autoTagging)
                ...
                private constructor(
                    ...
                    private constructor(
                         ...
                         *
                         * Unlike [semitransparency], this method doesn't throw if the JSON field
                        ...
                        class Builder internal constructor() {
                             ...
                             * undocumented or not yet supported value.
                             */
                            fun bgColor(bgColor: JsonField<String>) = apply {
                            ...
                            fun bgImageUrl(bgImageUrl: String) =
                                bgImageUrl(JsonField.of(bgImageUrl))
                ...
                private constructor(
                     ...
                     *
                     * Unlike [maxTags], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("maxTags")
                    @ExcludeMissing
                    fun _maxTags(): JsonField<Long> = maxTags
            ...
            override fun toString() =
                "UpdateFileDetails{customCoordinates=$customCoordinates, customMetadata=$customMetadata, extensions=$extensions, removeAiTags=$removeAiTags, tags=$tags, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                publish: JsonField<Publish> = JsonMissing.of()
            ...
            class Builder internal constructor() {
                ...
                internal fun from(changePublicationStatus: ChangePublicationStatus) = apply {
                    ...
                    additionalProperties =
                        changePublicationStatus.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.publish] with a well-typed [Publish] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                 ...
                 *
                 * Unlike [isPublished], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("isPublished")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.isPublished] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.includeFileVersions] with a well-typed
    ...
    override fun toString() =
        "DetailUpdateParams{fileId=$fileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
