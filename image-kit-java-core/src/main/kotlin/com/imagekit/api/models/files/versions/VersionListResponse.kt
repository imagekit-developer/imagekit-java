...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionListResponse: VersionListResponse) = apply {
            aiTags = versionListResponse.aiTags.map { it.toMutableList() }
            createdAt = versionListResponse.createdAt
            customCoordinates = versionListResponse.customCoordinates
            customMetadata = versionListResponse.customMetadata
            fileId = versionListResponse.fileId
            filePath = versionListResponse.filePath
            fileType = versionListResponse.fileType
            hasAlpha = versionListResponse.hasAlpha
            height = versionListResponse.height
            isPrivateFile = versionListResponse.isPrivateFile
            isPublished = versionListResponse.isPublished
            mime = versionListResponse.mime
            name = versionListResponse.name
            size = versionListResponse.size
            tags = versionListResponse.tags.map { it.toMutableList() }
            thumbnail = versionListResponse.thumbnail
            type = versionListResponse.type
            updatedAt = versionListResponse.updatedAt
            url = versionListResponse.url
            versionInfo = versionListResponse.versionInfo
            width = versionListResponse.width
