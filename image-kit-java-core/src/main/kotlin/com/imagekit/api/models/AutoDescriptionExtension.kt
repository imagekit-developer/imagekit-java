...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutoDescriptionExtension].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(autoDescriptionExtension: AutoDescriptionExtension) = apply {
            ...
            additionalProperties = autoDescriptionExtension.additionalProperties.toMutableMap()
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (name.asKnown().getOrNull()?.validity() ?: 0)
