...
class CustomMetadataFieldListResponse
private constructor(
    ...
    /** A builder for [CustomMetadataFieldListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customMetadataFieldListResponse: CustomMetadataFieldListResponse) =
            apply {
                id = customMetadataFieldListResponse.id
                label = customMetadataFieldListResponse.label
                name = customMetadataFieldListResponse.name
                schema = customMetadataFieldListResponse.schema
                additionalProperties =
                    customMetadataFieldListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomMetadataFieldListResponse].
         *
         ...
         */
        fun build(): CustomMetadataFieldListResponse =
            CustomMetadataFieldListResponse(
                checkRequired("id", id),
    ...
    fun validate(): CustomMetadataFieldListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * `DefaultValue.ofUnnamedSchemaWithArrayParent2s(unnamedSchemaWithArrayParent2s)`.
             */
            fun defaultValueOfUnnamedSchemaWithArrayParent2s(
                unnamedSchemaWithArrayParent2s: List<DefaultValue.UnnamedSchemaWithArrayParent2>
            ) =
                defaultValue(
                    DefaultValue.ofUnnamedSchemaWithArrayParent2s(unnamedSchemaWithArrayParent2s)
                )
        ...
        private constructor(
            ...
            override fun hashCode(): Int =
                Objects.hash(string, number, bool, unnamedSchemaWithArrayParent2s)
            ...
            override fun toString(): String =
                when {
                    ...
                    unnamedSchemaWithArrayParent2s != null ->
                        "DefaultValue{unnamedSchemaWithArrayParent2s=$unnamedSchemaWithArrayParent2s}"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomMetadataFieldListResponse &&
            id == other.id &&
            label == other.label &&
            name == other.name &&
            schema == other.schema &&
    ...
    override fun toString() =
        "CustomMetadataFieldListResponse{id=$id, label=$label, name=$name, schema=$schema, additionalProperties=$additionalProperties}"
}
