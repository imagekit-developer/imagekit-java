...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchDeleteResponse: BatchDeleteResponse) = apply {
            successfullyDeletedFileIds =
                batchDeleteResponse.successfullyDeletedFileIds.map { it.toMutableList() }
    ...
    override fun toString() =
        "BatchDeleteResponse{successfullyDeletedFileIds=$successfullyDeletedFileIds, additionalProperties=$additionalProperties}"
}
