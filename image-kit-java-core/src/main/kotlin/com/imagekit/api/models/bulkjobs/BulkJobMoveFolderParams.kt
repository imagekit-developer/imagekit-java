...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BulkJobMoveFolderParams].
         *
    ...
    /** A builder for [BulkJobMoveFolderParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkJobMoveFolderParams: BulkJobMoveFolderParams) = apply {
            body = bulkJobMoveFolderParams.body.toBuilder()
            additionalHeaders = bulkJobMoveFolderParams.additionalHeaders.toBuilder()
            additionalQueryParams = bulkJobMoveFolderParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BulkJobMoveFolderParams].
         *
         ...
         */
        fun build(): BulkJobMoveFolderParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkJobMoveFolderParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BulkJobMoveFolderParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
