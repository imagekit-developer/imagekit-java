...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileUploadV2Params].
         *
    ...
    /** A builder for [FileUploadV2Params]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileUploadV2Params: FileUploadV2Params) = apply {
            body = fileUploadV2Params.body.toBuilder()
            additionalHeaders = fileUploadV2Params.additionalHeaders.toBuilder()
            additionalQueryParams = fileUploadV2Params.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileUploadV2Params].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileUploadV2Params &&
            body == other.body &&
    ...
    override fun toString() =
        "FileUploadV2Params{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
