...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DamFileUpdateEvent].
         *
    ...
    /** A builder for [DamFileUpdateEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(damFileUpdateEvent: DamFileUpdateEvent) = apply {
            id = damFileUpdateEvent.id
            type = damFileUpdateEvent.type
            createdAt = damFileUpdateEvent.createdAt
            data = damFileUpdateEvent.data
            additionalProperties = damFileUpdateEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DamFileUpdateEvent].
         *
    ...
    fun validate(): DamFileUpdateEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DamFileUpdateEvent &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "DamFileUpdateEvent{id=$id, type=$type, createdAt=$createdAt, data=$data, additionalProperties=$additionalProperties}"
}
