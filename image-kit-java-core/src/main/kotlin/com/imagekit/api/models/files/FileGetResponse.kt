...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileGetResponse: FileGetResponse) = apply {
            aiTags = fileGetResponse.aiTags.map { it.toMutableList() }
            createdAt = fileGetResponse.createdAt
            customCoordinates = fileGetResponse.customCoordinates
            customMetadata = fileGetResponse.customMetadata
            fileId = fileGetResponse.fileId
            filePath = fileGetResponse.filePath
            fileType = fileGetResponse.fileType
            hasAlpha = fileGetResponse.hasAlpha
            height = fileGetResponse.height
            isPrivateFile = fileGetResponse.isPrivateFile
            isPublished = fileGetResponse.isPublished
            mime = fileGetResponse.mime
            name = fileGetResponse.name
            size = fileGetResponse.size
            tags = fileGetResponse.tags.map { it.toMutableList() }
            thumbnail = fileGetResponse.thumbnail
            type = fileGetResponse.type
            updatedAt = fileGetResponse.updatedAt
            url = fileGetResponse.url
            versionInfo = fileGetResponse.versionInfo
            width = fileGetResponse.width
