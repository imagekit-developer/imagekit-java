...
private constructor(
    ...
    /** A builder for [FileUploadV2Response]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileUploadV2Response: FileUploadV2Response) = apply {
            aiTags = fileUploadV2Response.aiTags.map { it.toMutableList() }
            audioCodec = fileUploadV2Response.audioCodec
            bitRate = fileUploadV2Response.bitRate
            customCoordinates = fileUploadV2Response.customCoordinates
            customMetadata = fileUploadV2Response.customMetadata
            duration = fileUploadV2Response.duration
            embeddedMetadata = fileUploadV2Response.embeddedMetadata
            extensionStatus = fileUploadV2Response.extensionStatus
            fileId = fileUploadV2Response.fileId
            filePath = fileUploadV2Response.filePath
            fileType = fileUploadV2Response.fileType
            height = fileUploadV2Response.height
            isPrivateFile = fileUploadV2Response.isPrivateFile
            isPublished = fileUploadV2Response.isPublished
            metadata = fileUploadV2Response.metadata
            name = fileUploadV2Response.name
            size = fileUploadV2Response.size
            tags = fileUploadV2Response.tags.map { it.toMutableList() }
            thumbnailUrl = fileUploadV2Response.thumbnailUrl
            url = fileUploadV2Response.url
            versionInfo = fileUploadV2Response.versionInfo
            videoCodec = fileUploadV2Response.videoCodec
            width = fileUploadV2Response.width
            additionalProperties = fileUploadV2Response.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileUploadV2Response].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileUploadV2Response =
    ...
    fun validate(): FileUploadV2Response = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileUploadV2Response &&
            aiTags == other.aiTags &&
            audioCodec == other.audioCodec &&
            bitRate == other.bitRate &&
