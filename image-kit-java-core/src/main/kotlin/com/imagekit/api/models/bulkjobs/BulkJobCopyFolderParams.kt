...
private constructor(
    ...
    /** A builder for [BulkJobCopyFolderParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkJobCopyFolderParams: BulkJobCopyFolderParams) = apply {
            body = bulkJobCopyFolderParams.body.toBuilder()
            additionalHeaders = bulkJobCopyFolderParams.additionalHeaders.toBuilder()
            additionalQueryParams = bulkJobCopyFolderParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BulkJobCopyFolderParams].
         *
         ...
         */
        fun build(): BulkJobCopyFolderParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkJobCopyFolderParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BulkJobCopyFolderParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
