...
class BulkJobMoveFolderResponse
private constructor(
    ...
    /** A builder for [BulkJobMoveFolderResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkJobMoveFolderResponse: BulkJobMoveFolderResponse) = apply {
            jobId = bulkJobMoveFolderResponse.jobId
            additionalProperties = bulkJobMoveFolderResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BulkJobMoveFolderResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BulkJobMoveFolderResponse =
            BulkJobMoveFolderResponse(jobId, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BulkJobMoveFolderResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkJobMoveFolderResponse &&
            jobId == other.jobId &&
    ...
    override fun toString() =
        "BulkJobMoveFolderResponse{jobId=$jobId, additionalProperties=$additionalProperties}"
}
