...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(metadataRetrieveParams: MetadataRetrieveParams) = apply {
            fileId = metadataRetrieveParams.fileId
        ...
        fun build(): MetadataRetrieveParams =
            MetadataRetrieveParams(fileId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "MetadataRetrieveParams{fileId=$fileId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
