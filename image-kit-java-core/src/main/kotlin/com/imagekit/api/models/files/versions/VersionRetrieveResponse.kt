...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionRetrieveResponse: VersionRetrieveResponse) = apply {
            aiTags = versionRetrieveResponse.aiTags.map { it.toMutableList() }
            createdAt = versionRetrieveResponse.createdAt
            customCoordinates = versionRetrieveResponse.customCoordinates
            customMetadata = versionRetrieveResponse.customMetadata
            fileId = versionRetrieveResponse.fileId
            filePath = versionRetrieveResponse.filePath
            fileType = versionRetrieveResponse.fileType
            hasAlpha = versionRetrieveResponse.hasAlpha
            height = versionRetrieveResponse.height
            isPrivateFile = versionRetrieveResponse.isPrivateFile
            isPublished = versionRetrieveResponse.isPublished
            mime = versionRetrieveResponse.mime
            name = versionRetrieveResponse.name
            size = versionRetrieveResponse.size
            tags = versionRetrieveResponse.tags.map { it.toMutableList() }
            thumbnail = versionRetrieveResponse.thumbnail
            type = versionRetrieveResponse.type
            updatedAt = versionRetrieveResponse.updatedAt
            url = versionRetrieveResponse.url
            versionInfo = versionRetrieveResponse.versionInfo
            width = versionRetrieveResponse.width
