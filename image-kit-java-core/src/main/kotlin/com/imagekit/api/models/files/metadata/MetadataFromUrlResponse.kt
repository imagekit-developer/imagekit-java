...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MetadataFromUrlResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MetadataFromUrlResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(metadataFromUrlResponse: MetadataFromUrlResponse) = apply {
            audioCodec = metadataFromUrlResponse.audioCodec
            bitRate = metadataFromUrlResponse.bitRate
            density = metadataFromUrlResponse.density
            duration = metadataFromUrlResponse.duration
            exif = metadataFromUrlResponse.exif
            format = metadataFromUrlResponse.format
            hasColorProfile = metadataFromUrlResponse.hasColorProfile
            hasTransparency = metadataFromUrlResponse.hasTransparency
            height = metadataFromUrlResponse.height
            pHash = metadataFromUrlResponse.pHash
            quality = metadataFromUrlResponse.quality
            size = metadataFromUrlResponse.size
            videoCodec = metadataFromUrlResponse.videoCodec
            width = metadataFromUrlResponse.width
            additionalProperties = metadataFromUrlResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MetadataFromUrlResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MetadataFromUrlResponse =
    ...
    fun validate(): MetadataFromUrlResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MetadataFromUrlResponse &&
    ...
    override fun toString() =
        "MetadataFromUrlResponse{audioCodec=$audioCodec, bitRate=$bitRate, density=$density, duration=$duration, exif=$exif, format=$format, hasColorProfile=$hasColorProfile, hasTransparency=$hasTransparency, height=$height, pHash=$pHash, quality=$quality, size=$size, videoCodec=$videoCodec, width=$width, additionalProperties=$additionalProperties}"
}
