...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DetailRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DetailRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailRetrieveResponse: DetailRetrieveResponse) = apply {
            aiTags = detailRetrieveResponse.aiTags.map { it.toMutableList() }
            createdAt = detailRetrieveResponse.createdAt
            customCoordinates = detailRetrieveResponse.customCoordinates
            customMetadata = detailRetrieveResponse.customMetadata
            fileId = detailRetrieveResponse.fileId
            filePath = detailRetrieveResponse.filePath
            fileType = detailRetrieveResponse.fileType
            hasAlpha = detailRetrieveResponse.hasAlpha
            height = detailRetrieveResponse.height
            isPrivateFile = detailRetrieveResponse.isPrivateFile
            isPublished = detailRetrieveResponse.isPublished
            mime = detailRetrieveResponse.mime
            name = detailRetrieveResponse.name
            size = detailRetrieveResponse.size
            tags = detailRetrieveResponse.tags.map { it.toMutableList() }
            thumbnail = detailRetrieveResponse.thumbnail
            type = detailRetrieveResponse.type
            updatedAt = detailRetrieveResponse.updatedAt
            url = detailRetrieveResponse.url
            versionInfo = detailRetrieveResponse.versionInfo
            width = detailRetrieveResponse.width
            additionalProperties = detailRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DetailRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailRetrieveResponse =
    ...
    fun validate(): DetailRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailRetrieveResponse &&
            aiTags == other.aiTags &&
