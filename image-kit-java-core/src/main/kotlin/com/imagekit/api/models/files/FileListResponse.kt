...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileListResponse: FileListResponse) = apply {
            aiTags = fileListResponse.aiTags.map { it.toMutableList() }
            createdAt = fileListResponse.createdAt
            customCoordinates = fileListResponse.customCoordinates
            customMetadata = fileListResponse.customMetadata
            fileId = fileListResponse.fileId
            filePath = fileListResponse.filePath
            fileType = fileListResponse.fileType
            hasAlpha = fileListResponse.hasAlpha
            height = fileListResponse.height
            isPrivateFile = fileListResponse.isPrivateFile
            isPublished = fileListResponse.isPublished
            mime = fileListResponse.mime
            name = fileListResponse.name
            size = fileListResponse.size
            tags = fileListResponse.tags.map { it.toMutableList() }
            thumbnail = fileListResponse.thumbnail
            type = fileListResponse.type
            updatedAt = fileListResponse.updatedAt
            url = fileListResponse.url
            versionInfo = fileListResponse.versionInfo
