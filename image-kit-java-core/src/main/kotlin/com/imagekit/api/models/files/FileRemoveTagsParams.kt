...
/**
 * This API removes tags from multiple files in bulk. A maximum of 50 files can be specified at a
 * time.
 */
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileRemoveTagsParams].
         *
    ...
    /** A builder for [FileRemoveTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileRemoveTagsParams: FileRemoveTagsParams) = apply {
            body = fileRemoveTagsParams.body.toBuilder()
            additionalHeaders = fileRemoveTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileRemoveTagsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileRemoveTagsParams].
         *
         ...
         */
        fun build(): FileRemoveTagsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileRemoveTagsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FileRemoveTagsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
