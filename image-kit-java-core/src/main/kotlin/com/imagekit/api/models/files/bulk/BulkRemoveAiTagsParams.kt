...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BulkRemoveAiTagsParams].
         *
    ...
    /** A builder for [BulkRemoveAiTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkRemoveAiTagsParams: BulkRemoveAiTagsParams) = apply {
            body = bulkRemoveAiTagsParams.body.toBuilder()
            additionalHeaders = bulkRemoveAiTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = bulkRemoveAiTagsParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): BulkRemoveAiTagsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkRemoveAiTagsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BulkRemoveAiTagsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
