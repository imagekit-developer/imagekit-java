...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DetailUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DetailUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailUpdateResponse: DetailUpdateResponse) = apply {
            aiTags = detailUpdateResponse.aiTags.map { it.toMutableList() }
            ...
            tags = detailUpdateResponse.tags.map { it.toMutableList() }
            ...
            additionalProperties = detailUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DetailUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailUpdateResponse =
    ...
    fun validate(): DetailUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailUpdateResponse &&
            aiTags == other.aiTags &&
