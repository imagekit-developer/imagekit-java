...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FileRemoveTagsResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileRemoveTagsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileRemoveTagsResponse: FileRemoveTagsResponse) = apply {
            successfullyUpdatedFileIds =
                fileRemoveTagsResponse.successfullyUpdatedFileIds.map { it.toMutableList() }
            additionalProperties = fileRemoveTagsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileRemoveTagsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileRemoveTagsResponse =
    ...
    fun validate(): FileRemoveTagsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileRemoveTagsResponse &&
    ...
    override fun toString() =
        "FileRemoveTagsResponse{successfullyUpdatedFileIds=$successfullyUpdatedFileIds, additionalProperties=$additionalProperties}"
}
