...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FileAddTagsResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileAddTagsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileAddTagsResponse: FileAddTagsResponse) = apply {
            successfullyUpdatedFileIds =
                fileAddTagsResponse.successfullyUpdatedFileIds.map { it.toMutableList() }
            additionalProperties = fileAddTagsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileAddTagsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileAddTagsResponse =
            FileAddTagsResponse(
    ...
    fun validate(): FileAddTagsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileAddTagsResponse &&
    ...
    override fun toString() =
        "FileAddTagsResponse{successfullyUpdatedFileIds=$successfullyUpdatedFileIds, additionalProperties=$additionalProperties}"
}
