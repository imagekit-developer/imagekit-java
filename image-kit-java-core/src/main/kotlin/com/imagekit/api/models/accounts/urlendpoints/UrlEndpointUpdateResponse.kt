...
class UrlEndpointUpdateResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlEndpointUpdateResponse].
         *
    ...
    /** A builder for [UrlEndpointUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlEndpointUpdateResponse: UrlEndpointUpdateResponse) = apply {
            id = urlEndpointUpdateResponse.id
            description = urlEndpointUpdateResponse.description
            origins = urlEndpointUpdateResponse.origins.map { it.toMutableList() }
            urlPrefix = urlEndpointUpdateResponse.urlPrefix
            urlRewriter = urlEndpointUpdateResponse.urlRewriter
            additionalProperties = urlEndpointUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlEndpointUpdateResponse].
         *
         ...
         */
        fun build(): UrlEndpointUpdateResponse =
    ...
    fun validate(): UrlEndpointUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlEndpointUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "UrlEndpointUpdateResponse{id=$id, description=$description, origins=$origins, urlPrefix=$urlPrefix, urlRewriter=$urlRewriter, additionalProperties=$additionalProperties}"
}
