...
private constructor(
    ...
    /** A builder for [FileAddTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileAddTagsParams: FileAddTagsParams) = apply {
            body = fileAddTagsParams.body.toBuilder()
            additionalHeaders = fileAddTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileAddTagsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileAddTagsParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileAddTagsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FileAddTagsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
