 ...
 * and its versions will be appended to the destination file.
 */
class FileMoveParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileMoveParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileMoveParams: FileMoveParams) = apply {
            body = fileMoveParams.body.toBuilder()
            additionalHeaders = fileMoveParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileMoveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileMoveParams].
         *
         ...
         */
        fun build(): FileMoveParams =
            FileMoveParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
        ...
        ) : this(destinationPath, sourceFilePath, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(destinationPath, sourceFilePath, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{destinationPath=$destinationPath, sourceFilePath=$sourceFilePath, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileMoveParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FileMoveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
