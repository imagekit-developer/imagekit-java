...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlEndpointListResponse].
         *
    ...
    /** A builder for [UrlEndpointListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlEndpointListResponse: UrlEndpointListResponse) = apply {
            id = urlEndpointListResponse.id
            description = urlEndpointListResponse.description
            origins = urlEndpointListResponse.origins.map { it.toMutableList() }
            urlPrefix = urlEndpointListResponse.urlPrefix
            urlRewriter = urlEndpointListResponse.urlRewriter
            additionalProperties = urlEndpointListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlEndpointListResponse].
         *
         ...
         */
        fun build(): UrlEndpointListResponse =
    ...
    fun validate(): UrlEndpointListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlEndpointListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "UrlEndpointListResponse{id=$id, description=$description, origins=$origins, urlPrefix=$urlPrefix, urlRewriter=$urlRewriter, additionalProperties=$additionalProperties}"
}
