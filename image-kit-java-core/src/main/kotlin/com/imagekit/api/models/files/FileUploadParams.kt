...
private constructor(
     ...
     */
    fun _expire(): MultipartField<Long> = body._expire()
    ...
    class Builder internal constructor() {
         ...
         * file from the client side.
         */
        fun expire(expire: Long) = apply { body.expire(expire) }

        /**
         * Sets [Builder.expire] to an arbitrary multipart value.
         *
         * You should usually call [Builder.expire] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
