...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [body] with `Body.ofFileUploadV1ByUrl(fileUploadV1ByUrl)`. */
        fun body(fileUploadV1ByUrl: Body.FileUploadV1ByUrl) =
            body(Body.ofFileUploadV1ByUrl(fileUploadV1ByUrl))
    ...
    private constructor(
        ...
        private val fileUploadV1ByUrl: FileUploadV1ByUrl? = null,
        private val _json: JsonValue? = null,
    ) {

        fun fileUploadV1(): Optional<FileUploadV1> = Optional.ofNullable(fileUploadV1)

        fun fileUploadV1ByUrl(): Optional<FileUploadV1ByUrl> =
            Optional.ofNullable(fileUploadV1ByUrl)

        fun isFileUploadV1(): Boolean = fileUploadV1 != null

        fun isFileUploadV1ByUrl(): Boolean = fileUploadV1ByUrl != null

        fun asFileUploadV1(): FileUploadV1 = fileUploadV1.getOrThrow("fileUploadV1")

        fun asFileUploadV1ByUrl(): FileUploadV1ByUrl =
            fileUploadV1ByUrl.getOrThrow("fileUploadV1ByUrl")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                fileUploadV1ByUrl != null -> visitor.visitFileUploadV1ByUrl(fileUploadV1ByUrl)
        ...
        fun validate(): Body = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitFileUploadV1ByUrl(fileUploadV1ByUrl: FileUploadV1ByUrl) {
                        fileUploadV1ByUrl.validate()
                    }
                }
            )
            validated = true
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Body &&
                ...
                fileUploadV1ByUrl == other.fileUploadV1ByUrl
        }

        override fun hashCode(): Int = Objects.hash(fileUploadV1, fileUploadV1ByUrl)

        override fun toString(): String =
            when {
                fileUploadV1 != null -> "Body{fileUploadV1=$fileUploadV1}"
                fileUploadV1ByUrl != null -> "Body{fileUploadV1ByUrl=$fileUploadV1ByUrl}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofFileUploadV1ByUrl(fileUploadV1ByUrl: FileUploadV1ByUrl) =
                Body(fileUploadV1ByUrl = fileUploadV1ByUrl)
        }
        ...
        interface Visitor<out T> {
            ...
            fun visitFileUploadV1ByUrl(fileUploadV1ByUrl: FileUploadV1ByUrl): T
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Body {
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<FileUploadV1ByUrl>())?.let {
                                Body(fileUploadV1ByUrl = it, _json = json)
                            },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Body>(Body::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.fileUploadV1ByUrl != null ->
                        generator.writeObject(value.fileUploadV1ByUrl)
        ...
        private constructor(
            ...
            /**
             * A publicly reachable URL that ImageKit’s servers can fetch. The server must receive
             * the response headers within 8 seconds; otherwise the request fails with 400 Bad
             * Request.
             *
             * @throws ImageKitInvalidDataException if the JSON field has an unexpected type or is
             *   unexpectedly missing or null (e.g. if the server responded with an unexpected
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [FileUploadV1ByUrl].
                 *
                 * The following fields are required:
                 * ```java
                 * .file()
            ...
            /** A builder for [FileUploadV1ByUrl]. */
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(fileUploadV1ByUrl: FileUploadV1ByUrl) = apply {
                    file = fileUploadV1ByUrl.file
                    fileName = fileUploadV1ByUrl.fileName
                    token = fileUploadV1ByUrl.token
                    checks = fileUploadV1ByUrl.checks
                    customCoordinates = fileUploadV1ByUrl.customCoordinates
                    customMetadata = fileUploadV1ByUrl.customMetadata
                    description = fileUploadV1ByUrl.description
                    expire = fileUploadV1ByUrl.expire
                    extensions = fileUploadV1ByUrl.extensions.map { it.toMutableList() }
                    folder = fileUploadV1ByUrl.folder
                    isPrivateFile = fileUploadV1ByUrl.isPrivateFile
                    isPublished = fileUploadV1ByUrl.isPublished
                    overwriteAiTags = fileUploadV1ByUrl.overwriteAiTags
                    overwriteCustomMetadata = fileUploadV1ByUrl.overwriteCustomMetadata
                    overwriteFile = fileUploadV1ByUrl.overwriteFile
                    overwriteTags = fileUploadV1ByUrl.overwriteTags
                    publicKey = fileUploadV1ByUrl.publicKey
                    responseFields = fileUploadV1ByUrl.responseFields.map { it.toMutableList() }
                    signature = fileUploadV1ByUrl.signature
                    tags = fileUploadV1ByUrl.tags.map { it.toMutableList() }
                    transformation = fileUploadV1ByUrl.transformation
                    useUniqueFileName = fileUploadV1ByUrl.useUniqueFileName
                    webhookUrl = fileUploadV1ByUrl.webhookUrl
                    additionalProperties = fileUploadV1ByUrl.additionalProperties.toMutableMap()
                }
                ...
                /**
                 * Returns an immutable instance of [FileUploadV1ByUrl].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
            ...
            fun validate(): FileUploadV1ByUrl = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is FileUploadV1ByUrl &&
                    file == other.file &&
                    fileName == other.fileName &&
                    token == other.token &&
                    checks == other.checks &&
            ...
            override fun toString() =
                "FileUploadV1ByUrl{file=$file, fileName=$fileName, token=$token, checks=$checks, customCoordinates=$customCoordinates, customMetadata=$customMetadata, description=$description, expire=$expire, extensions=$extensions, folder=$folder, isPrivateFile=$isPrivateFile, isPublished=$isPublished, overwriteAiTags=$overwriteAiTags, overwriteCustomMetadata=$overwriteCustomMetadata, overwriteFile=$overwriteFile, overwriteTags=$overwriteTags, publicKey=$publicKey, responseFields=$responseFields, signature=$signature, tags=$tags, transformation=$transformation, useUniqueFileName=$useUniqueFileName, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
        }
    }
