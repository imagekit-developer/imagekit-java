...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MetadataGetResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MetadataGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(metadataGetResponse: MetadataGetResponse) = apply {
            audioCodec = metadataGetResponse.audioCodec
            bitRate = metadataGetResponse.bitRate
            density = metadataGetResponse.density
            duration = metadataGetResponse.duration
            exif = metadataGetResponse.exif
            format = metadataGetResponse.format
            hasColorProfile = metadataGetResponse.hasColorProfile
            hasTransparency = metadataGetResponse.hasTransparency
            height = metadataGetResponse.height
            pHash = metadataGetResponse.pHash
            quality = metadataGetResponse.quality
            size = metadataGetResponse.size
            videoCodec = metadataGetResponse.videoCodec
            width = metadataGetResponse.width
            additionalProperties = metadataGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MetadataGetResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MetadataGetResponse =
            MetadataGetResponse(
                audioCodec,
                bitRate,
                density,
    ...
    fun validate(): MetadataGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MetadataGetResponse &&
    ...
    override fun toString() =
        "MetadataGetResponse{audioCodec=$audioCodec, bitRate=$bitRate, density=$density, duration=$duration, exif=$exif, format=$format, hasColorProfile=$hasColorProfile, hasTransparency=$hasTransparency, height=$height, pHash=$pHash, quality=$quality, size=$size, videoCodec=$videoCodec, width=$width, additionalProperties=$additionalProperties}"
}
