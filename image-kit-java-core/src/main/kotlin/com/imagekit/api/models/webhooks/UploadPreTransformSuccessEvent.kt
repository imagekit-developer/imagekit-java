...
private constructor(
     ...
     * ```java
     * JsonValue.from("upload.pre-transform.success")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("upload.pre-transform.success")
    ...
    fun validate(): UploadPreTransformSuccessEvent = apply {
        ...
        request().validate()
        _type().let {
            if (it != JsonValue.from("upload.pre-transform.success")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("upload.pre-transform.success")) 1 else 0 }
    ...
    private constructor(
         ...
         *
         * Unlike [extensionStatus], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("extensionStatus")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                aiTags = data.aiTags.map { it.toMutableList() }
                ...
                embeddedMetadata = data.embeddedMetadata
             ...
             * `x,y,width,height`. If `customCoordinates` are not defined, then it is `null`. Send
             * `customCoordinates` in `responseFields` in API request to get the value of this
             * field.
             */
            ...
            /**
             * Consolidated embedded metadata associated with the file. It includes exif, iptc, and
             * xmp data. Send `embeddedMetadata` in `responseFields` in API request to get
             ...
             * [EmbeddedMetadata] value instead. This method is primarily for setting the field to
             ...
             *
             * `success`: The extension has been successfully applied. `failed`: The extension has
             * failed and will not be retried. `pending`: The extension will finish processing in
             * some time. On completion, the final status (success / failed) will be sent to the
             * `webhookUrl` provided.
             *
             * If no extension was requested, then this parameter is not returned.
             */
            ...
            /**
             * Unique fileId. Store this fileld in your database, as this will be used to perform
             * update action on this file.
             */
             ...
             * `isPrivateFile` in `responseFields` in API request to get the value of this field.
             */
            ...
            /**
             * Legacy metadata. Send `metadata` in `responseFields` in API request to get metadata
             * in the upload API response.
             */
        ...
        private constructor(
             ...
             *
             * Unlike [aiAutoDescription], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("ai-auto-description")
            @ExcludeMissing
             ...
             *
             * Unlike [awsAutoTagging], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("aws-auto-tagging")
            @ExcludeMissing
             ...
             *
             * Unlike [googleAutoTagging], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("google-auto-tagging")
            @ExcludeMissing
             ...
             *
             * Unlike [removeBg], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("remove-bg")
            @ExcludeMissing
            fun _removeBg(): JsonField<RemoveBg> = removeBg
            ...
            class Builder internal constructor() {
                 ...
                 * [AiAutoDescription] value instead. This method is primarily for setting the field
                 ...
                 *
                 * You should usually call [Builder.awsAutoTagging] with a well-typed
                 * [AwsAutoTagging] value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 * [GoogleAutoTagging] value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                 ...
                 * member.
                 *
                 * An instance of [AiAutoDescription] can contain an unknown value in a couple of
                 * cases:
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        FAILED -> Known.FAILED
                            ...
                            throw ImageKitInvalidDataException("Unknown AiAutoDescription: $value")
                    }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [AwsAutoTagging]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [AwsAutoTagging] can contain an unknown value in a couple of
                 * cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                ...
                enum class Value {
                    ...
                    FAILED,
                    /**
                     * An enum member indicating that [AwsAutoTagging] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                 ...
                 * member.
                 *
                 * An instance of [GoogleAutoTagging] can contain an unknown value in a couple of
                 * cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        FAILED -> Known.FAILED
                            ...
                            throw ImageKitInvalidDataException("Unknown GoogleAutoTagging: $value")
                    }
            ...
            class RemoveBg @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                enum class Value {
                    ...
                    FAILED,
                    /**
                     * An enum member indicating that [RemoveBg] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
