...
class CustomMetadataFieldUpdateResponse
private constructor(
    ...
    /** A builder for [CustomMetadataFieldUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customMetadataFieldUpdateResponse: CustomMetadataFieldUpdateResponse) =
            apply {
                id = customMetadataFieldUpdateResponse.id
                label = customMetadataFieldUpdateResponse.label
                name = customMetadataFieldUpdateResponse.name
                schema = customMetadataFieldUpdateResponse.schema
                additionalProperties =
                    customMetadataFieldUpdateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomMetadataFieldUpdateResponse].
         *
         ...
         */
        fun build(): CustomMetadataFieldUpdateResponse =
            CustomMetadataFieldUpdateResponse(
                checkRequired("id", id),
    ...
    fun validate(): CustomMetadataFieldUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun defaultValueOfJsonScalarArray(
                jsonScalarArray: List<DefaultValue.UnnamedSchemaWithArrayParent1>
        ...
        private constructor(
            ...
            private val jsonScalarArray: List<UnnamedSchemaWithArrayParent1>? = null,
            ...
            fun jsonScalarArray(): Optional<List<UnnamedSchemaWithArrayParent1>> =
            ...
            fun asJsonScalarArray(): List<UnnamedSchemaWithArrayParent1> =
                ...
                accept(
                    object : Visitor<Unit> {
                        ...
                        override fun visitJsonScalarArray(
                            jsonScalarArray: List<UnnamedSchemaWithArrayParent1>
                        ) {
            ...
            companion object {
                ...
                @JvmStatic
                fun ofJsonScalarArray(jsonScalarArray: List<UnnamedSchemaWithArrayParent1>) =
            ...
            interface Visitor<out T> {
                ...
                fun visitJsonScalarArray(jsonScalarArray: List<UnnamedSchemaWithArrayParent1>): T
            ...
            private constructor(
                ...
                override fun toString(): String =
                    when {
                        jsonScalar != null ->
                            "UnnamedSchemaWithArrayParent1{jsonScalar=$jsonScalar}"
                        jsonScalar != null ->
                            "UnnamedSchemaWithArrayParent1{jsonScalar=$jsonScalar}"
                        jsonScalar != null ->
                            "UnnamedSchemaWithArrayParent1{jsonScalar=$jsonScalar}"
                ...
                internal class Deserializer :
                    ...
                    override fun ObjectCodec.deserialize(
                        ...
                        val bestMatches =
                            sequenceOf(
                                    tryDeserialize(node, jacksonTypeRef<String>())?.let {
                                        UnnamedSchemaWithArrayParent1(jsonScalar = it, _json = json)
                                    },
                                    tryDeserialize(node, jacksonTypeRef<Double>())?.let {
                                        UnnamedSchemaWithArrayParent1(jsonScalar = it, _json = json)
                                    },
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomMetadataFieldUpdateResponse &&
            id == other.id &&
            label == other.label &&
            name == other.name &&
            schema == other.schema &&
    ...
    override fun toString() =
        "CustomMetadataFieldUpdateResponse{id=$id, label=$label, name=$name, schema=$schema, additionalProperties=$additionalProperties}"
}
