 ...
 * through this API or using the dashboard UI, its value can be set on the assets. The value of a
 * field for an asset can be set using the media library UI or programmatically through upload or
 * update assets API.
 */
...
private constructor(
     ...
     * setting field value on an asset in the media library UI.
     *
    ...
    /**
     * API name of the custom metadata field. This should be unique across all (including deleted)
    ...
    /** A builder for [CustomMetadataFieldCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customMetadataFieldCreateParams: CustomMetadataFieldCreateParams) =
            apply {
                body = customMetadataFieldCreateParams.body.toBuilder()
                additionalHeaders = customMetadataFieldCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    customMetadataFieldCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * while setting field value on an asset in the media library UI.
         */
         ...
         */
        fun build(): CustomMetadataFieldCreateParams =
            CustomMetadataFieldCreateParams(
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * users while setting field value on an asset in the media library UI.
             */
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun defaultValueOfMixed(mixed: List<DefaultValue.UnnamedSchemaWithArrayParent8>) =
        ...
        private constructor(
            ...
            private val mixed: List<UnnamedSchemaWithArrayParent8>? = null,
             ...
             * `MultiSelect`.
             */
            fun mixed(): Optional<List<UnnamedSchemaWithArrayParent8>> = Optional.ofNullable(mixed)
             ...
             * `MultiSelect`.
             */
            fun asMixed(): List<UnnamedSchemaWithArrayParent8> = mixed.getOrThrow("mixed")
            ...
            fun validate(): DefaultValue = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        ...
                        override fun visitMixed(mixed: List<UnnamedSchemaWithArrayParent8>) {
            ...
            companion object {
                 ...
                 */
                @JvmStatic
                fun ofMixed(mixed: List<UnnamedSchemaWithArrayParent8>) =
            ...
            interface Visitor<out T> {
                 ...
                 * `MultiSelect`.
                 */
                fun visitMixed(mixed: List<UnnamedSchemaWithArrayParent8>): T
            ...
            private constructor(
                ...
                override fun toString(): String =
                    when {
                        ...
                        number != null -> "UnnamedSchemaWithArrayParent8{number=$number}"
                        bool != null -> "UnnamedSchemaWithArrayParent8{bool=$bool}"
                        _json != null -> "UnnamedSchemaWithArrayParent8{_unknown=$_json}"
                        else -> throw IllegalStateException("Invalid UnnamedSchemaWithArrayParent8")
                    }

                companion object {

                    @JvmStatic
                    fun ofString(string: String) = UnnamedSchemaWithArrayParent8(string = string)

                    @JvmStatic
                    fun ofNumber(number: Double) = UnnamedSchemaWithArrayParent8(number = number)

                    @JvmStatic
                    fun ofBool(bool: Boolean) = UnnamedSchemaWithArrayParent8(bool = bool)
                }
                ...
                interface Visitor<out T> {
                    ...
                    /**
                     * Maps an unknown variant of [UnnamedSchemaWithArrayParent8] to a value of type
                     * [T].
                     *
                     * An instance of [UnnamedSchemaWithArrayParent8] can contain an unknown variant
                    ...
                    override fun ObjectCodec.deserialize(
                        ...
                        val bestMatches =
                            sequenceOf(
                                    ...
                                    tryDeserialize(node, jacksonTypeRef<Double>())?.let {
                                        UnnamedSchemaWithArrayParent8(number = it, _json = json)
                                    },
                                    tryDeserialize(node, jacksonTypeRef<Boolean>())?.let {
                                        UnnamedSchemaWithArrayParent8(bool = it, _json = json)
                                    },
                                )
                                .filterNotNull()
                                .allMaxBy { it.validity() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomMetadataFieldCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CustomMetadataFieldCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
