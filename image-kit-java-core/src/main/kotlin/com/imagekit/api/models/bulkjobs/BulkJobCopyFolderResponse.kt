...
class BulkJobCopyFolderResponse
private constructor(
    ...
    /** A builder for [BulkJobCopyFolderResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkJobCopyFolderResponse: BulkJobCopyFolderResponse) = apply {
            jobId = bulkJobCopyFolderResponse.jobId
            additionalProperties = bulkJobCopyFolderResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BulkJobCopyFolderResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BulkJobCopyFolderResponse =
            BulkJobCopyFolderResponse(jobId, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BulkJobCopyFolderResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkJobCopyFolderResponse &&
            jobId == other.jobId &&
    ...
    override fun toString() =
        "BulkJobCopyFolderResponse{jobId=$jobId, additionalProperties=$additionalProperties}"
}
