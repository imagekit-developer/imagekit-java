...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlEndpoint].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlEndpoint: UrlEndpoint) = apply {
            description = urlEndpoint.description
            origins = urlEndpoint.origins.map { it.toMutableList() }
            urlPrefix = urlEndpoint.urlPrefix
            urlRewriter = urlEndpoint.urlRewriter
            additionalProperties = urlEndpoint.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlEndpoint].
         *
    ...
    fun validate(): UrlEndpoint = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "UrlEndpoint{description=$description, origins=$origins, urlPrefix=$urlPrefix, urlRewriter=$urlRewriter, additionalProperties=$additionalProperties}"
}
