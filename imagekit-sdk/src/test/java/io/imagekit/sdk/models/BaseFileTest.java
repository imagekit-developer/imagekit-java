...
public class BaseFileTest {
	...
	public void constructor_test() {
		...
		SUT = new BaseFile("fileId", "name", "url", "thumbnail", 10, 10, 20, "filePath", tags, true, "0,0,10,20",
				"image", new JsonArray(), new JsonObject(), new JsonObject(), new JsonObject(), new JsonObject(),
				"file", "image/jpeg", false, new Date(), new Date());
		assertNotNull(SUT);
	}
